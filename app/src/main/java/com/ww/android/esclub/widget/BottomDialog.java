...
public class BottomDialog extends Dialog {
    ...
    private static final int DEFAULT_OPTION_SIZE = 18;
    ...
    private BottomDialog(Context context) {
        ...
        super(context);
        View view = LayoutInflater.from(context).inflate(R.layout.layout_ios_bottom_dialog,null);
...
//        window.setWindowAnimations(R.style.ios_bottom_dialog_anim);
    ...
    private void setBottomDialogDismissListener(BottomDialogDismissListener listener) {
    ...
    public static class Builder {
        ...
        public Builder setDialogDismissListener(BottomDialogDismissListener listener) {
        ...
        public BottomDialog create() {
            ...
            if (p.options.size() == 0) {
                ...
                for (int i = 0; i < p.options.size(); i++) {
                    ...
                    int padding = ScreenUtil.getScalePxValue(DEFAULT_PADDING);
                    ...
                    if (i != p.options.size() - 1) {
                        ...
                        divider.setBackgroundResource(R.color.color_b3b3b3);
            ...
            //对话框dismiss之后的监听
            dialog.setBottomDialogDismissListener(p.dismisslistener);
            return dialog;
        }
    }
    ...
    public List<View> getChildViews(){
        ...
        for (int i = 0; i < options_ll.getChildCount(); i++) {
            views.add(options_ll.getChildAt(i));
        }
        return views;
    }
    ...
    private static class Paraments {
        ...
        boolean cancelable;
        List<Option> options;
        BottomDialog.BottomDialogDismissListener dismisslistener;
